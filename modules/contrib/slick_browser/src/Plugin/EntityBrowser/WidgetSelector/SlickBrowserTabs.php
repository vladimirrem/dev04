...
class SlickBrowserTabs extends Tabs {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['tabs_position'] = [
      ...
      '#description'   => $this->t('Left and Right positions are more suitable for large displays such as Modal. With more tab items, it is better to use Left or Right position.'),
    ];
  ...
  public function submitConfigurationForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->configuration['buttons_position'] = $values['buttons_position'];
    $this->configuration['tabs_position'] = $values['tabs_position'];
  }
